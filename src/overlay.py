...
class Overlay(ScaledWindow):
    ...
    def __init__(self, args):
        ...
        self.passed_cards_label = Label(self.passed_frame, text="Value of Passed Cards", style="MainSectionsBold.TLabel")
        ...
        self.passed_table = self._create_header(
            "passed_table",
            self.passed_table_frame,
            0,
            self.fonts_dict["All.TableRow"],
            passed_table_headers,
            self.table_width,
        ...
        self.signal_frame.grid(row=17, column=0, columnspan=2, sticky="nsew")
        self.signal_label.pack(anchor="w")
        self.signal_table.pack(expand=True, fill="both")

        footnote_label.grid(row=18, column=0, columnspan=2)
    ...
    def __display_widgets(self):
        ...
        # TODO fix this
        toggle_widget(self.passed_frame, 1)
        toggle_widget(self.passed_table_frame, 1)
